...
public:
    ...
    bool renderImage(const String &imgPath, int x, int y, int max_x = BOOK_PAGE_W, int max_y = BOOK_PAGE_H, uint8_t align = ALIGN_CENTER, bool invert = 0, bool andCache = false, bool exactFit = false);
